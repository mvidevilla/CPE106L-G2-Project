...
def update_details():
    ...
    saveButton = ctk.CTkButton(updateWindow, text="Save", command=save, fg_color="#4CAF50")  # Green
    saveButton.grid(row=2, column=0, padx=10, pady=10, sticky="ew")  

    discardButton = ctk.CTkButton(updateWindow, text="Discard", command=discard, fg_color="#F44336")  # Red
    discardButton.grid(row=2, column=1, padx=10, pady=10, sticky="ew")
